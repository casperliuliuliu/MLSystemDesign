...
image_path = '/Users/liushiwen/Desktop/大四下/precident.jpg'
...
# # Optionally, convert mask to an image (useful for visualization)
# mask_image = (mask * 255).astype(np.uint8)  # Convert boolean mask to an 8-bit image
